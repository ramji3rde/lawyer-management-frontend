  ...
  handleSubmit = async (event) => {
    ...
    if (validateForm()) {
      ...
      if (editMode) {
        ...
        api.post('contact/create', { ...data, userName }).then((result) => {
          console.log(result)
          notification.success({
            message:
              dataList.fileList.length !== 0
                ? "Contact created"
                : "Contact created, Create a Matter for this contact"
          })
            ...
            api
              ...
              .then((res) => {
                ...
                if (res.status === 200) {
                  setTimeout(() => {
                    message.success({
                      content: 'Image Uploaded!, Create a matter for the client',
                      key,
                      duration: 3,
                    });
                  }, 1000);
                  if (this.props.location != undefined) {
                    ...
                    this.props.history.push('/manage/matter');
                  }
                } else {
                  console.log({ res });
                  if (this.props.location != undefined) {
