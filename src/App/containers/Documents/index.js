...
const Documents = (props) => {
        ...
        if (uploadData.document === '') {
          ...
          if (uploadData.matter === '') {
            ...
            if (uploadData.name === '') {
              ...
              docFormData.set('userName', user.userName);
              ...
              api
                ...
                .then(function (response) {
                  notification.success({ message: 'Document Uploaded! Continue to add a task' });
                  getDocuments();
        ...
        if (tempDocx.document === '') {
          ...
          if (tempDocx.matter === '') {
            ...
            if (tempDocx.name === '') {
              ...
              setDisable(true)
              api
                .post('/document/uploadtemplate/934894383948u43', { ...tempDocx, userName: user.userName })
                .then(function (response) {
  ...
  const AddCategory = () => {
    if (CatagoryData.name === '') {
      ...
      console.log(CatagoryData)
      api
        .post('/document/category/create/', { ...CatagoryData, userName: user.userName })
        .then(function (response) {
          console.log(response)
          getCategory()
  ...
  const addFolder = () => {
    if (FolderData.name === '') {
      ...
      console.log(FolderData)
      api
        .post('/document/folder/create', { ...FolderData, userName: user.userName })
        .then(function (response) {
          console.log(response)
          getFolder()
