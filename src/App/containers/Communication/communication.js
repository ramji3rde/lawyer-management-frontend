...
class Communication extends React.Component {
  ...
  componentDidMount() {
    ...
    const { _id, userName, isOwner } = this.props.user
    ...
    api.get('/contact/viewforuser/' + _id).then((res) => {
      contact = res
    ...
    api.get('/communication/viewforuser/' + _id).then((res) => {
          ...
          if (this.state.editEmail || this.state.editPhone) {
            ...
            api.get(`/contact/view/${data.to}`).then((res) => {
              ...
              api.post(`/communication/sendemail`, email).then((email) => {
                ...
                api
                  .post('/communication/create', {...data, userName: this.props.user.userName})
                  .then((res) => {
                    console.log(res)
                    this.componentDidMount()
