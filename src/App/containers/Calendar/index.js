  ...
  const handleSubmit = (e) => {
    ...
    if (e.requestType === "eventCreated") {
      ...
      if (data.title == "" || data.title == undefined) {
        ...
        api.post('/calendar/create', { ...eventdata, userName: user.userName }).then((res) => {
          //console.log(res, '00000000000000000000000000000000000000')
          fetchEventData()
          ...
          <ScheduleComponent height='550px'
            ...
            editorTemplate={pr => (
              <EditorTemplate {...pr}
                ...
                setRecurrenceRef={ref => recurrenceRef.current = ref} />
            )}>
