...
const TestimonialsPage = React.lazy(()=>import('./App/containers/Auth/testimonialsPage'))
...
const route = [
    ...
    { path: '/testimonials', exact: true, name: 'Testimonials', component: TestimonialsPage },
